...
class StretchyCollectionViewLayout: UICollectionViewLayout {
    ...
    override func layoutAttributesForItem(at indexPath: IndexPath) -> UICollectionViewLayoutAttributes? {
        ...
        if indexPath.section > 0 {
            ...
            let previousCell = layoutAttributesForItem(at: IndexPath(item: lastItem, section: previousSection) as IndexPath)
    ...
    override func layoutAttributesForSupplementaryView(ofKind elementKind: String, at indexPath: IndexPath) -> UICollectionViewLayoutAttributes? {
        ...
        let attribute = UICollectionViewLayoutAttributes(forSupplementaryViewOfKind: StretchyCollectionHeaderKind, with: indexPath as IndexPath)
    ...
    override var collectionViewContentSize: CGSize {
        ...
        guard let lastCell = layoutAttributesForItem(at: IndexPath(item: lastItem, section: lastSection) as IndexPath) else {
            return CGSize.zero
        }
